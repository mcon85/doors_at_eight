...
Review.create(user_id: u3.id, venue_id: v2.id, rating: 5, body: "Run river north played. Amazing. Everything was on schedule and the set up between the opener and run river north was short. Everything was smooth letting us focus on the music. And also the bartender was great. Shots are big!")

Review.create(user_id: u4.id, venue_id: v2.id, rating: 4, body: "A small-ish venue where the stage is high enough and the floor wide enough so that everyone can see and hear the band? These are the unicorns of the concert hall world. Somehow, BMH fits the bill. ")

Review.create(user_id: u2.id, venue_id: v2.id, rating: 5, body: "Went here a lot over the years when it was named Harper's Ferry and have seen some great bands Vast, Antigones Rising, etc. I just went to see Aurora. The sound system is top notch, the beer fairly priced and the staff... just ridiculously friendly. Will be returning.")

Review.create(user_id: u2.id, venue_id: v3.id, rating: 5, body: "The Royal is an amazing Vaudeville Art Deco venue in downtown Boston. I went to see Allen Stone here the other night which was awesome, and making the event even better was the quality of the venue and its staff.")

Review.create(user_id: u2.id, venue_id: v4.id, rating: 4, body: "Came here for the Naked and Famous show and it was great! The venue's got a separate bar room from the concert room so not everyone is trying to listen to music and crowd the bartender all at the same time. For a few bucks there's also coat check (protip: get your coat during encore or prepare to wait!).")

Review.create(user_id: u2.id, venue_id: v5.id, rating: 4, body: "Paradise Rock Club might actually be one of my favorite small concert venues in the Boston area. The acoustics are fantastic, there are several bars spread out across the venue for maximum drink intake(decent prices too!), and the second floor is by far the best part.")

Review.create(user_id: u3.id, venue_id: v6.id, rating: 1, body: "Venue staff are friendly I guess but not well trained/knowledgeable. They usually offer front of the line access to the concert to those that dine in their restaurant. I called in advance to confirm and was told that's the case but then it wasn't when I showed up. THANKS GUYS.")

Review.create(user_id: u4.id, venue_id: v6.id, rating: 2, body: "I've probably been to the House of Blues a dozen times throughout the years. I do not love the venue, but they continue to book shows that I want to see, and thus... I go")

Review.create(user_id: u4.id, venue_id: v7.id, rating: 4, body: "Great place to see some talented musicians. We went to see Charlie peacock and it was a pleasant experience!
The cafe had great coffee and the room was rocking!")

Review.create(user_id: u3.id, venue_id: v8.id, rating: 4, body: "I love this venue! If you're looking for an intimate show, I recommend checking out Great Scott! It's so small that we were able to chat with the artists. I also like how you can just sit and watch the show too. Tickets are also quite affordable here.")

Review.create(user_id: u2.id, venue_id: v8.id, rating: 5, body: "This is a great tiny venue. You can either get right up front and be as close to the stage as possible, or if you prefer you can sit at some high tables towards the back and still see perfectly. Most shows are in the $10-$12 range.")

Review.create(user_id: u3.id, venue_id: v5.id, rating: 1, body: "I went to see Stephen Marley at the paradise...I love Ragga and have seen him many times all over New England and the world... this venue I've been to 3 times and all three times I had to TRY to have a good time. The artists are always on point but the hospitality of this venue is POOR -- each time there was a problem with rude bartenders and staff!!!")

Review.create(user_id: u2.id, venue_id: v7.id, rating: 5, body: "I came here for a Berklee performance, and it was lovely! I didn't have any of the food, but it seemed like a place for students and regular Bostonians alike. The venue was small and intimate--really nice! This was a cabaret of broadway tunes. The students were really talented and the show was free!  A wonderful Boston gem.")

Review.create(user_id: u2.id, venue_id: v1.id, rating: 3, body: "Pros: vintage feel, great location, good capacity. Lots of great bars and restaurants near by, adjacent to Park MBTA stop. Cons: hard to navigate, crowded tight spaces, old narrow seats, low balcony. Bottom line if you are going here you are probably more concerned about the band itself, but be prepared for an 'old-school' experience.")
