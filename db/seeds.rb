...
r1 = Review.create(user_id: , venue_id: , rating: , body: "")
...
r3 = Review.create(user_id: u4.id, venue_id: v2.id, rating: 5, body: "A small-ish venue where the stage is high enough and the floor wide enough so that everyone can see and hear the band? These are the unicorns of the concert hall world. Somehow, BMH fits the bill. ")
...
# Venue 8
r14 = Review.create(user_id: u3.id, venue_id: v8.id, rating: 4, body: "I love this venue! If you're looking for an intimate show, I recommend checking out Great Scott! It's so small that we were able to chat with the artists. I also like how you can just sit and watch the show too. Tickets are also quite affordable here.")
r15 = Review.create(user_id: u2.id, venue_id: v8.id, rating: 5, body: "This is a great tiny venue. You can either get right up front and be as close to the stage as possible, or if you prefer you can sit at some high tables towards the back and still see perfectly. Most shows are in the $10-$12 range.")
